...
const CopyButton = ({value, active, setActive}) => {
    return (
        <div className='copy-btn'>
            ...
            <button className="copy-btn__btn" onClick={() => {setActive(true); setTimeout(() => { setActive(false) }, 1000); navigator.clipboard.writeText(value)}}>
